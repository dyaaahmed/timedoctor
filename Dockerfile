...
RUN apt-get update -y && \
    ...
    libdbus-glib-1-2 apt-get install -qqy x11-apps -y
RUN curl -o /mnt/time.AppImage https://repo2.timedoctor.com/td-desktop-hybrid/prod/timedoctor-desktop_latest_linux-x86_64.AppImage
